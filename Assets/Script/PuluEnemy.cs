...
public class PuluEnemy : MonoBehaviour
{
    // Variabel untuk menyimpan referensi ke script Player dan AudioManager
    private PlayerMovement komponenPemain;
    private AudioManager audioManager;

    // Awake dijalankan sekali saat objek musuh ini dibuat
    private void Awake()
    {
